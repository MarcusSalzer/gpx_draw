...
find_files_os = dataf.find_importable
...
N_test = 10
os_time = timeit(lambda: find_files_os(folder, extensions), number=N_test) / N_test
...
print(
    "df equality?",
    find_files_os(folder, extensions).equals(find_files_glob(folder, extensions)),
)
print()
